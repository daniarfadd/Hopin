...
class ProfileEditActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showPreferenceInForm() {
        ...
        binding.edtFinancial.setText(userModel.financial.toString())
    ...
    override fun onClick(v: View) {
        if (v.id == R.id.btn_save) {
            ...
            val financial = binding.edtFinancial.text.toString().trim()
            val phoneNo = binding.edtPhone.text.toString().trim()
            val isGender = binding.rgGender.checkedRadioButtonId == R.id.rb_yes
            ...
            if (financial.isEmpty()) {
                binding.edtFinancial.error = FIELD_REQUIRED
                return
            }
            ...
            saveUser(name, email, age, financial, phoneNo, isGender)
    ...
    private fun saveUser(name: String, email: String, age: String, phoneNo: String,financial: String, isGender: Boolean) {
        val userPreference = UserPreference(this)

        userModel.name = name
        userModel.email = email
        userModel.age = Integer.parseInt(age)
        userModel.financial = Integer.parseInt(financial)
        userModel.phoneNumber = phoneNo
        userModel.isGender = isGender
